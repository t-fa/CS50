...
$(document).ready(function() {
    ...
    let options = {
        center: {lat: 40.6396473, lng: -74.036539}, // Brooklyn, New York
...
{
    let coords = new google.maps.LatLng({lat: place['latitude'], lng: place['longitude']})
    ...
    // https://jasonalvernaz.com/2018/10/01/cs50-pset-8-mashup-part-2/
    //Get articles
    ...
    },
    {
        ...
        templates: {
            suggestion: Handlebars.compile(
                "<div>" +
                "{{place_name}}, {{admin_name1}}, {{postal_code}}, {{admin_code1}}" +
                "</div>"
            )
        }
    });
